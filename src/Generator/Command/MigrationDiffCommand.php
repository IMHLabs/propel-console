...
use Propel\Generator\Command\MigrationDiffCommand as baseClass;
 ...
 * @link      https://inmotionhosting.com
 */
class MigrationDiffCommand extends baseClass
{
    /**
     * Configure Command
     *
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $skippedTables = [];
        if ($this->hasInputOption('skip-tabler', $input)) {
            $skippedTables = $input->getOption('skip-tables');
        }
        $skippedTables[] = 'propel_data_migration';
        $input->setOption('skip-tabler', $skippedTables);
